...
export default (boardSize, mineNum) => {
    ...
    for (let m = 0; m < boardSize; m++) {
        for (let n = 0; n < boardSize; n++) {
            if ((m > 0) && (n > 0)) { if (board[m - 1][n - 1].value === '💣') { if (board[m][n].value !== '💣') { board[m][n].value += 1; } } }
            if (m > 0) { if (board[m - 1][n].value === '💣') { if (board[m][n].value !== '💣') { board[m][n].value += 1; } } }
            if ((m > 0) && (n < boardSize - 1)) { if (board[m - 1][n + 1].value === '💣') { if (board[m][n].value !== '💣') { board[m][n].value += 1; } } }
            if (n > 0) { if (board[m][n - 1].value === '💣') { if (board[m][n].value !== '💣') { board[m][n].value += 1; } } }
            if ((m < boardSize - 1) && (n > 0)) { if (board[m + 1][n - 1].value === '💣') { if (board[m][n].value !== '💣') { board[m][n].value += 1; } } }
            if (m < boardSize - 1) { if (board[m + 1][n].value === '💣') { if (board[m][n].value !== '💣') { board[m][n].value += 1; } } }
            if ((m < boardSize - 1) && (n < boardSize - 1)) { if (board[m + 1][n + 1].value === '💣') { if (board[m][n].value !== '💣') { board[m][n].value += 1; } } }
            if (n < boardSize - 1) { if (board[m][n + 1].value === '💣') { if (board[m][n].value !== '💣') { board[m][n].value += 1; } } }
        }
    }
